                ...
                {auth ?
                    ...
                    <div>
                        <ul className="hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:flex lg:mx-auto lg:items-center lg:w-auto lg:space-x-6">
                            ...
                            <li><Link to={'/'} className="text-sm text-blue-800 hover:text-gray-500">Dashboard</Link></li>
                            <li><Link to={'/#'} className="text-sm text-blue-800 hover:text-gray-500" >Demandes</Link></li>
                            <li><Link to={'/'} className="text-sm text-blue-800 hover:text-gray-500">Services</Link></li>
                            <li><Link to={'/#'} className="text-sm text-blue-800 hover:text-gray-500" >Equipes</Link></li>
                        </ul>
                        <Link to={'/login'} className="hidden lg:inline-block lg:ml-auto lg:mr-3 py-2 px-6 bg-blue-800 hover:bg-blue-600 text-sm text-white font-bold rounded-xl transition duration-200" >
                            Deconnexion
                        </Link>
                    </div>
                }
